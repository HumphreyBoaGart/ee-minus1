...
class Minus1 {
	...
	public function __construct()
	{
		...
		if (ctype_digit($precount))
		{
			...
			$logitem = 'Minus1 plugin error: Provided input contains non-numeric characters.';
			ee()->load->library('logger');
			ee()->logger->developer($logitem);
			$this->return_data = '<div class="alert alert-danger" role="alert">'.$logitem.'</div>';
		}		
	}
}
